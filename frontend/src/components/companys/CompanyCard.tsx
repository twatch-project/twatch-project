  ...
  return (
    <>
      <Link to={`/company/${companyId}`}>
        <div className="card hover:scale-[1.011]  duration-150 w-[280px] h-full border border-md p-5 rounded-md flex flex-col justify-between">
          <div className="head">
            <div className="imgBx bg-[#eee] h-60 w-full">
