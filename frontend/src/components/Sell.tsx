        ...
        <section className="flex flex-col justify-between  items-center my-5 p-[15px] m-auto">
          ...
          <div className="flex footer ">
            <div className="flex flex-col h-20 text-center box1">
              ...
              <h3 className="font-bold">Search หา Constructors ง่ายๆ</h3>
              <p className="p-2">พิจารณาจากผลงาน ความสามารถเเละริวิว</p>
            </div>
            <div className="flex flex-col h-20 text-center box1">
              <div className="icon flex justify-center my-[5px]">
                <svg
                  fill="#000000"
                  width="40px"
                  height="40px"
              ...
              <h3 className="font-bold">ชำระเงินผ่าน Twatch</h3>
              <p className="p-2">Twatch Guarantee ได้งานเเน่นอน</p>
            </div>
            <div className="flex flex-col h-20 text-center box1">
              <div className="icon flex justify-center my-[10px]">
                <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <h3 className="font-bold">อนุมัติงานเเละริวิว</h3>
              <p className="p-2">ตรวจสอบงานที่ได้รับ อนุมัติ เเละริวิวงาน</p>
            </div>
            <div className="flex flex-col h-20 text-center box1">
              <div className="icon flex justify-center my-[10px]">
                <svg
              ...
              <h3 className="font-bold">พูดคุยรายละเอียด</h3>
